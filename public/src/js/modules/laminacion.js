    ...
    initTemporizadores: function() {
        ...
        document.getElementById('btnProdStop')?.addEventListener('click', async () => {
            ...
            try {
                ...
                await self.descontarInventarioLaminacion(datos);
                ...
                console.error('[Laminacion] Error guardando turno:', e);
        ...
        document.getElementById('btnFinalizarOrden')?.addEventListener('click', () => {
            ...
            if (typeof showToast === 'function') showToast('Complete la devolucion para finalizar la orden.', 'info');
        });
    },
    timerTick: function() {
